...
reads
\[
  0.963,\;0.965,\;0.968,\;0.970,\;0.972,\;0.974,\;0.976
  \qquad (k=18,20,\dots,30),
\]
increasing monotonically towards $1$; the corresponding ratios to
$2(\sqrt3/2)^{|B_d|}$ move \emph{away} from $1$, which is what identifies the
extra factor $\sqrt3/2$. The value at $k=32$ is $1.025$, an outlier stable
across window widths that we do not presently explain.
