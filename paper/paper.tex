...
dominated by the smallest elements --- that equals the window measure $W_D$.
...
window measure with the whole tail $(2D+1)2^{-k}$ still attached, whereas
Definition~\ref{def:gap} is the window measure at the last informative layer,
...
$n=\lfloor T/2\rfloor$. The fifth column is the window measure $W_D$ at the last
