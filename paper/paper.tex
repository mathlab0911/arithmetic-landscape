...
ones. In particular the gap series has not been looked up as an integer sequence
in a way we can point at, so if $\Gamma$ or the numerators
$3,11,29,69,151,\dots$ of $2^{k}\Gamma(P_k)$ are already catalogued, we would be
glad to be told.
