...
with amplitude correction $K_2$ and phase drift $\psi$. Section~\ref{sec:num}
...
The canon currently consists of $92$ theorems.
...
is $0.0034$, attained at $k=18$; this is the smallest $k$ in the range and the
one where the class-independent term $S_4/S_2^{2}$ is largest ($0.1111$,
decreasing monotonically to $0.0507$ at $k=40$).
...
The amplitude is extracted from a narrow window (half-width $24$, which is
between $0.08$ and $0.30$ standard deviations over the range); wide windows
corrupt the Gaussian reference. The phase slope requires \emph{wide} windows,
